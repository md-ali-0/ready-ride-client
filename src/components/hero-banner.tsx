            ...
            >
                ...
                <div className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
                    <div className="max-w-xl">
                        ...
                        >
                            Affordable Bike Rentals for Your Next Urban
                            Adventure
                        </motion.p>

                        <motion.div
                                whileInView={{ opacity: [0, 1], x: [-20, 0] }}
                                transition={{ duration: 1, delay: 1 }} className="mt-8 flex flex-wrap gap-4 text-center">
                            <Link
                                to="/bikes"
                ...
                {isSearchActive && (
                    <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-gray-900 bg-opacity-90 px-5 sm:px-0">
                        <div className="flex w-full max-w-xl px-6 py-2.5 rounded-full bg-background border focus-within:border">
                            <input
                                type="search"
                        ...
                        <button
                            onClick={closeSearch}
                            className="absolute top-5 md:top-8 right-3 md:right-8 bg-gray-900 dark:bg-gray-500 rounded-full text-white text-3xl ps-2 p-2"
                        >
                            <X />
                        </button>
